        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <div>
                   ...
                   <a href="./student_add.php" class="btn btn-primary" role="button"><span class="glyphicon glyphicon-plus" aria-hidden="true"> Ajouter un étudiant</span></a>
                            ...
                            <td>
                                <?php
                                    foreach($tcbr as $key=>$student) {
                                        ...
                                        echo "<a href='student_edit.php?noCarte=$noCarte&nom=$nom&prenom=$prenom&admission=$admission&filiere=$filiere'>$prenom $nom</a>";
                                        if($key < count($tcbr) - 1) {
                                            echo ", ";
                                        }
                                    } 
