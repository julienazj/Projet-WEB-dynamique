    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <div style="float : right;"><a href="regle_actuel.php?noCarte=<?php echo $noCarte ?>">Voir sa conformité de règles actuelle</a></div>
                ...
                <table class='table table-bordered' style="font-weight : bold; border-left : 0px; border-bottom : 0px">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td colspan="2" align="center">
                                <?php
                                    ...
                                    echo "$credit_tcbr/42 <span style='color : blue;'>(R01)</span>";
                                    if($credit_tcbr >= 42) {
                        ...
                        <tr>
                            ...
                            <td colspan="2" align="center">
                                <?php
                                    ...
                                    echo "$credit_fcbr/18 <span style='color : blue;'>(R02)</span>";
                                    if($credit_fcbr >= 18) {
                                        echo "<span class='glyphicon glyphicon-ok' aria-hidden='true' style='color : #0D0;'></span>";
                                    } else {
                                        echo "<span class='glyphicon glyphicon-remove' aria-hidden='true' style='color : #D00;'></span>";
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <?php
                                    ...
                                    echo "$credit_cs/24 <span style='color : blue;'>(R03)</span>";
                                    if($credit_cs >= 24) {
                                        echo "<span class='glyphicon glyphicon-ok' aria-hidden='true' style='color : #0D0;'></span>";
                                    } else {
                                        echo "<span class='glyphicon glyphicon-remove' aria-hidden='true' style='color : #D00;'></span>";
                            ...
                            <td align="center">
                                <?php
                                    ...
                                    echo "$credit_tm/24 <span style='color : blue;'>(R04)</span>";
                                    if($credit_tm >= 24) {
                                        echo "<span class='glyphicon glyphicon-ok' aria-hidden='true' style='color : #0D0;'></span>";
                                    } else {
                                        echo "<span class='glyphicon glyphicon-remove' aria-hidden='true' style='color : #D00;'></span>";
                        ...
                        <tr>
                            ...
                            <td colspan="2" align="center">
                                <?php
                                    echo $credit_cs + $credit_tm;
                                    echo "/84 <span style='color : blue;'>(R05)</span>";
                                    if($credit_cs + $credit_tm >= 84) {
                                        echo "<span class='glyphicon glyphicon-ok' aria-hidden='true' style='color : #0D0;'></span>";
                                    } else {
                                        echo "<span class='glyphicon glyphicon-remove' aria-hidden='true' style='color : #D00;'></span>";
                                    }
                            ...
                            <td align="center">
                                <?php
                                    ...
                                    echo "$credit_st/60 <span style='color : blue;'>(R06+R07)</span>";
                                    if($credit_st >= 60) {
                                        echo "<span class='glyphicon glyphicon-ok' aria-hidden='true' style='color : #0D0;'></span>";
                                    } else {
                                        echo "<span class='glyphicon glyphicon-remove' aria-hidden='true' style='color : #D00;'></span>";
                            ...
                            <td align="center">
                                <?php
                                    ...
                                    echo "$credit_ec/12 <span style='color : blue;'>(R08)</span>";
                                    if($credit_ec >= 12) {
                                        echo "<span class='glyphicon glyphicon-ok' aria-hidden='true' style='color : #0D0;'></span>";
                                    } else {
                                        echo "<span class='glyphicon glyphicon-remove' aria-hidden='true' style='color : #D00;'></span>";
                            ...
                            <td align="center">
                                <?php
                                    ...
                                    echo "$credit_me/4 <span style='color : blue;'>(R09)</span>";
                                    if($credit_me >= 4) {
                                        echo "<span class='glyphicon glyphicon-ok' aria-hidden='true' style='color : #0D0;'></span>";
                                    } else {
                                        echo "<span class='glyphicon glyphicon-remove' aria-hidden='true' style='color : #D00;'></span>";
                            ...
                            <td align="center">
                                <?php
                                    ...
                                    echo "$credit_ct/4 <span style='color : blue;'>(R10)</span>";
                                    if($credit_ct >= 4) {
                                        echo "<span class='glyphicon glyphicon-ok' aria-hidden='true' style='color : #0D0;'></span>";
                                    } else {
                                        echo "<span class='glyphicon glyphicon-remove' aria-hidden='true' style='color : #D00;'></span>";
                            ...
                            <td align="center">
                                <?php
                                    echo "<span style='color : blue;'>(R14)</span>";
                                    $flagN = false;
                        ...
                        <tr>
                            ...
                            <td colspan="2" align="center">
                                ...
                                <?php
                                    ...
                                    echo " $credit_utt/60 <span style='color : blue;'>(R12)</span>";
                                    if($credit_utt >= 60) {
                                        echo "<span class='glyphicon glyphicon-ok' aria-hidden='true' style='color : #0D0;'></span>";
                                    } else {
                                        echo "<span class='glyphicon glyphicon-remove' aria-hidden='true' style='color : #D00;'></span>";
                            ...
                            <td colspan="2" align="center">
                                <?php
                                    ...
                                    echo " $credit_mect/16 <span style='color : blue;'>(R11)</span>";
                                    if($credit_mect >= 16) {
                                        echo "<span class='glyphicon glyphicon-ok' aria-hidden='true' style='color : #0D0;'></span>";
                                    } else {
                                        echo "<span class='glyphicon glyphicon-remove' aria-hidden='true' style='color : #D00;'></span>";
                        ...
                        <tr>
                            ...
                            <td colspan="9" align="center">
                                <?php
                                    ...
                                    echo " $credit_br/180 <span style='color : blue;'>(R15)</span>";
                                    if($credit_br >= 180) {
                                        echo "<span class='glyphicon glyphicon-ok' aria-hidden='true' style='color : #0D0;'></span>";
                                    } else {
                                        echo "<span class='glyphicon glyphicon-remove' aria-hidden='true' style='color : #D00;'></span>";
