    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>MANAGEMENT DE CURSUS </h2>   
                    </div>
                </div>              
                 <!-- /. ROW  -->
                <hr />
                <div class="alert alert-info">
                    Les cursus de <?php echo "$prenom $nom" ?>
                </div>
                <div>
                    <a href="./cursus_add.php?noCarte=<?php echo $noCarte ?>" class="btn btn-primary" role="button"><span class="glyphicon glyphicon-plus" aria-hidden="true"> Ajouter un cursus</span></a>
                    <a href="./cursus_add_csv.php?noCarte=<?php echo $noCarte ?>" class="btn btn-primary" role="button"><span class="glyphicon glyphicon-plus" aria-hidden="true"> Ajouter les cursus par CSV</span></a>
                    <a href="./cursus_export_csv.php?noCarte=<?php echo $noCarte ?>" class="btn btn-primary" role="button"><span class="glyphicon glyphicon-plus" aria-hidden="true"> Exporter le ficher CSV</span></a>
                </div>
                <br> 
